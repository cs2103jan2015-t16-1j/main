...
public class FindActionTest {
	...
	public void testFindName() {
		...
		assertEquals(String.format(MessageConstants.MESSAGE_MATCHES_FOUND, 1),
		...
		assertEquals(String.format(MessageConstants.MESSAGE_MATCHES_FOUND, 2),
				findTest.getFeedback().toString());
		...
		findTest.execute(displayList, masterList);
		assertEquals(2, displayList.size());
		assertEquals(MessageConstants.MESSAGE_NO_MATCHES_FOUND, findTest
	...
	public void testFindPriority() {
		...
		findTest.execute(displayList, masterList);
		assertEquals(1, displayList.size());
		assertEquals(MessageConstants.MESSAGE_NO_PRIORITY_LEVEL
				+ MessageConstants.MESSAGE_NO_MATCHES_FOUND, findTest
				.getFeedback().toString());
	}
	...
	public void testFindCompleted() {
		...
		assertEquals("task three", displayList.getLast().getName());
		assertEquals(2, displayList.size());
		assertEquals(MessageConstants.MESSAGE_NO_COMPLETE_CRITERIA
				+ MessageConstants.MESSAGE_NO_MATCHES_FOUND, findTest
				.getFeedback().toString());
