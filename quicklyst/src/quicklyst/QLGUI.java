...
public class QLGUI extends JFrame { 
    ...
    private JComponent setupOverviewPanel() {
        ...
        JLabel taskDetailsHeader = new JLabel("<html><u>Task Details</u></html>");
        taskDetailsHeader.setBorder(BorderFactory.createEmptyBorder(PADDING_OVERVIEW,
                PADDING_OVERVIEW, 0, PADDING_OVERVIEW));
    ...
    private void addComponents(JComponent taskListScroll,
            JComponent tipScroll, JComponent command, JComponent overview, JComponent status) {
        add(command);
        add(taskListScroll);
        add(tipScroll);
        add(overview);
    ...
    private void setConstraintsForMainFrame(SpringLayout layout,
        ...
        setConstraintsForCommandTextField(layout, contentPane, commandTextField, status);
        ...
        setConstraintsForTipScroll(layout, contentPane, taskListScroll,
                overviewScroll, tipScroll);
        setConstraintsForStatus(layout,
                contentPane, status);
    }

    private void setConstraintsForCommandTextField(SpringLayout layout,
            Container contentPane, JComponent commandTextField, JComponent status) {
    ...
    private void setConstraintsForOverviewPane(SpringLayout layout,
        ...
        layout.putConstraint(SpringLayout.SOUTH, overviewScroll, OFFSET_OVERVIEWPANE_SOUTH,
                SpringLayout.NORTH, tipScroll);
    ...
    private void setConstraintsForTipScroll(SpringLayout layout,
        ...
        layout.putConstraint(SpringLayout.WEST, tipScroll, OFFSET_TIPSCROLL_WEST,
                SpringLayout.EAST, taskListScroll);
        layout.putConstraint(SpringLayout.SOUTH, tipScroll, OFFSET_TIPSCROLL_SOUTH,
                SpringLayout.SOUTH, taskListScroll);
        layout.putConstraint(SpringLayout.EAST, tipScroll, OFFSET_TIPSCROLL_EAST,
                SpringLayout.EAST, contentPane);
